...
La càrrega requereix un moment constant de [[p14]] N·m, tan a l'arrencada com quan va a velocitat nominal.
...
Tot i que el problema principal és a l'arrencada es calcularan alguns valors nominals per assegurar que no s'ha de rectificar res una vegada s'aconsegueix arribar al règim estacionari. Suposant que la màquina es connecta en estrella a la tensió de línia [[p15]]
...
Per a comparar, s'estudia l'opció de instal·lar unes resistències rotòriques de [[p16]] Ω. En aquest supòsit:
